...
- Link to GitHub repository: [https://github.com/anoncreds/anoncreds-spec](https://github.com/anoncreds/anoncreds-spec)
- Link to Draft specification: [https://anoncreds.github.io/anoncreds-spec](https://anoncreds.github.io/anoncreds-spec)
...
- The AnonCreds v1.0 MUST align with the existing AnonCreds open source implementations in Hyperledger AnonCreds ([anoncreds-rs](https://github.com/anoncreds/anoncreds-rs) repo) and be Verifiable Data Registry-agnostic.
